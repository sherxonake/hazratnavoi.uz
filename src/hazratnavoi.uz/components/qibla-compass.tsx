  ...
  return (
    <section className="relative py-20 lg:py-28 bg-emerald-deep overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Compass Card */}
        <div className="bg-gradient-to-br from-emerald-800/60 via-emerald-900/60 to-emerald-800/60 backdrop-blur-xl rounded-3xl border-2 border-yellow-500/30 p-6 lg:p-10 shadow-2xl">
